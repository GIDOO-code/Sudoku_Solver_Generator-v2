...
namespace GNPZ_sdk{
    ...
    public class UAlgMethod{
        ...
        public override string ToString(){
            string st = $"{MethodName.PadRight(30)}[{DifLevel}] {UsedCC} GeneralLogic:{GenLogB}";
            return st;
        }
    }
    ...
    public class GNPX_AnalyzerMan{
        ...
        public  GNPX_AnalyzerMan( GNPZ_Engin pENGN ){
            ...
            SolverLst0.Add( new UAlgMethod( 16, "LockedSet(5D)",       -6, LockedSet.LockedSet5 ) );
            SolverLst0.Add( new UAlgMethod( 18, "LockedSet(6D)",       -6, LockedSet.LockedSet6 ) );
            SolverLst0.Add( new UAlgMethod( 20, "LockedSet(7D)",       -6, LockedSet.LockedSet7 ) );           
            ...
            SolverLst0.Add( new UAlgMethod( 17, "LockedSet(5D)Hidden", -6, LockedSet.LockedSet5Hidden ) );
            SolverLst0.Add( new UAlgMethod( 19, "LockedSet(6D)Hidden", -6, LockedSet.LockedSet6Hidden ) );            
            SolverLst0.Add( new UAlgMethod( 21, "LockedSet(7D)Hidden", -6, LockedSet.LockedSet7Hidden ) );
            ...
            SolverLst0.Add( new UAlgMethod( 33, "Squirmbag",       -6, Fish.Squirmbag ) );
            SolverLst0.Add( new UAlgMethod( 34, "Whale",           -6, Fish.Whale ) );
            SolverLst0.Add( new UAlgMethod( 35, "Leviathan",       -6, Fish.Leviathan ) );
            ...
            SolverLst0.Add( new UAlgMethod( 43, "Finned Squirmbag", 7, Fish.FinnedSquirmbag ) );
            SolverLst0.Add( new UAlgMethod( 44, "Finned Whale",     7, Fish.FinnedWhale ) );
            SolverLst0.Add( new UAlgMethod( 45, "Finned Leviathan", 7, Fish.FinnedLeviathan ) );
...
*/
            ...
            SolverLst0.Add( new UAlgMethod( 96, "NiceLoop",          11, NLTech.NiceLoop ) );

            var GNLTech=new GroupedLinkGen(this);
			SolverLst0.Add( new UAlgMethod(  97, "GroupedNiceLoop",  12, GNLTech.GroupedNiceLoop ) );
            ...
            SolverLst0.Add( new UAlgMethod( 111, "ForceChain_Cell",  12, GNLTech.ForceChain_Cell ) );
			SolverLst0.Add( new UAlgMethod( 112, "ForceChain_House", 12, GNLTech.ForceChain_House ) );
			SolverLst0.Add( new UAlgMethod( 113, "ForceChain_Contradiction",  12, GNLTech.ForceChain_Contradiction ) );
