...
#region Fish Manager
    public class FishMan{
        ...
        private List<Bit81F>  HBLst=new List<Bit81F>(); //element cells of fish(bit representation)
        ...
        public FishMan( AnalyzerBaseV2 AnB, int FMSize, int no, int sz, bool extFlag=false ){
            ...
            int noB=(1<<no);                                        //Bit representation of dijit(#no)
        ...
        private class Bit81F: Bit81{
            ...
            public Bit81F( Bit81 rcB, int ID ): base(rcB){
                ...
                rcbB = (rr) | (cc<<9) | (bb<<18);                  //Bit representation of block/column/block from rcB(0-80)
...
#region Fish
    public class UFish{
        ...
        public Bit81    BaseB81=null;   //Bit representation of baseSet cells
        public Bit81    EndoFin=null;   //Bit representation of EndoFin cells
        ...
        public Bit81    CoverB81=null;  //Bit representation of coverSet cells
        public Bit81    FinB81=null;    //Bit representation of fin cells
        public Bit81    CannFin=null;   //Bit representation of cannibalisticFin cells
