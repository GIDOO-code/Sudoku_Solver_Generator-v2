...
namespace GNPZ_sdk{
    public class LockedSetGenEx: AnalyzerBaseV3{
        public LockedSetGenEx( GNPX_AnalyzerManEx AnMan ): base(AnMan){ }
        ...
        public bool LockedSetSub( int sz, bool HiddenFlag ){
            ...
            for( int tfx=0; tfx<27; tfx++ ){
                List<UCellEx>  BDLstF = pBDL.IEGetCellInHouse(tfx,0x1FF).ToList();
