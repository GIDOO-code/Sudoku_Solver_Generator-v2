...
namespace GNPZ_sdk{
    public class LatinSqureGen{
        static  public int? SeedX=null;
        private bool    __DEBUGmode__=false;  //true;

        private int LatSqrParaMax = 55*6*6*6*6*6*6;
        ...
        public void GeneratePara( ref int[,] pSol99, int s1=0, int s2=0 ){
            ...
            //Console.WriteLine("-------------------- Top:{0} Left:{1}", s1, s2 );
     ...
     //       PLft = new int[]{13,2,0,5,3,2,3,0};
        ...
        private void _LatinSqureSub_12( ){
            ...
            if( pSol99[3,0]==pSol99[3,2] ){ Console.WriteLine("<<< Error >>>"); }
