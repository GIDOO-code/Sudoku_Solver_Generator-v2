...
namespace GNPXcore {
  ...
  #region UALS
    public class UALS: IComparable{
        ...
        public int      rcbRow{ get{ return (rcbDir&0x1FF); } }      //row expression
        public int      rcbCol{ get{ return ((rcbDir>>9)&0x1FF); } } //column expression
        public int      rcbBlk{ get{ return ((rcbDir>>18)&0x1FF); } }//block expression
