...
namespace GNPXcore{
    public partial class FishGen: AnalyzerBaseV2{
        ...
        // http://csdenpe.web.fc2.com/page34.html
        public bool XWing(){     return Fish_Basic(2); }
        public bool SwordFish(){ return Fish_Basic(3); }
        public bool JellyFish(){ return Fish_Basic(4); }
        public bool Squirmbag(){ return Fish_Basic(5); }    //complementary to 4D 
        public bool Whale(){     return Fish_Basic(6); }    //complementary to 3D 
        public bool Leviathan(){ return Fish_Basic(7); }    //complementary to 2D 
